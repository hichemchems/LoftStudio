...
# Script to simplify Express static configuration for o2switch deployment
# This creates a backup and modifies backend/app.js to remove complex headers

echo "🔧 Simplifying Express static configuration for o2switch..."

# Backup current backend/app.js
cp backend/app.js backend/app.js.backup.$(date +%Y%m%d_%H%M%S)
echo "✅ Backup created: backend/app.js.backup.$(date +%Y%m%d_%H%M%S)"

# Create simplified version
cat > backend/app.js.simplified << 'EOF'
...
// SIMPLIFIED: Serve static files without complex headers
...
echo "✅ Simplified version created: backend/app.js.simplified"
echo ""
echo "📋 Changes made:"
echo "- Removed complex setHeaders function from express.static"
echo "- Removed cache control headers"
echo "- Simplified static file serving"
echo ""
echo "🔄 To apply the simplified version:"
echo "cp backend/app.js.simplified backend/app.js"
echo ""
echo "🧪 Then test with:"
