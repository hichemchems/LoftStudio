...
echo "3. Configurez le point d'entrée: server.js"
...
echo ""
echo "⚠️ Note: Socket.io est désactivé en environnement Passenger."
echo "   Les fonctionnalités temps réel ne seront pas disponibles."
